...
Template.puzzel_level2.rendered = function(){
  $(document).ready(function() {
    ...
    var settings = { 
      ...
      success: { 
        ...
        callback: function(results){
          Meteor.call('insertHighscore', Meteor.userId(), 'puzzel', 2, results.score, function (err, res){
          ...
          setTimeout(function(){Meteor.Router.to('/viewscorepuzzelevel2')}, 1000);
    ...
    $('#gamePuzzle_level2').jqPuzzle(settings);
  });
}
